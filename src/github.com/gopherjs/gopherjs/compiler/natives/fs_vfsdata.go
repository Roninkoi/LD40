...
var FS = func() http.FileSystem {
	...
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: mustUnmarshalTextTime("2017-07-25T18:23:18Z"),
		},
		"/src": &vfsgen۰DirInfo{
			name:    "src",
		...
		"/src/internal/poll/fd_poll_js.go": &vfsgen۰CompressedFileInfo{
			name:             "fd_poll_js.go",
			modTime:          mustUnmarshalTextTime("2017-07-25T17:23:48Z"),
		...
		"/src/math/big/big.go": &vfsgen۰CompressedFileInfo{
			name:             "big.go",
			modTime:          mustUnmarshalTextTime("2017-07-25T17:41:35Z"),
		...
		"/src/os/signal/signal.go": &vfsgen۰CompressedFileInfo{
			name:             "signal.go",
			modTime:          mustUnmarshalTextTime("2017-07-25T19:32:58Z"),
		...
		"/src/reflect/reflect.go": &vfsgen۰CompressedFileInfo{
			name:             "reflect.go",
			modTime:          mustUnmarshalTextTime("2017-07-25T19:30:00Z"),
		...
		"/src/sync/export_test.go": &vfsgen۰CompressedFileInfo{
			name:             "export_test.go",
			modTime:          mustUnmarshalTextTime("2017-07-25T18:23:07Z"),
		...
		"/src/sync/sync.go": &vfsgen۰CompressedFileInfo{
			name:             "sync.go",
			modTime:          mustUnmarshalTextTime("2017-07-25T19:26:36Z"),
		...
		"/src/sync/sync_test.go": &vfsgen۰CompressedFileInfo{
			name:             "sync_test.go",
			modTime:          mustUnmarshalTextTime("2017-07-25T18:06:27Z"),
		...
		"/src/testing/testing.go": &vfsgen۰FileInfo{
			name:    "testing.go",
			modTime: mustUnmarshalTextTime("2017-07-25T19:24:40Z"),
